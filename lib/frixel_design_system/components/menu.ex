                ...
                <div class="grid grid-cols-4 gap-2">
                  <div :for={sublink <- link.dropdown} class="flex flex-col items-start w-full">
                    <.link
                      ...
                      class="block w-full"
                    >
                      <div class="w-full h-32 overflow-hidden hover:bg-base-200 transition-colors duration-200 mb-2">
                        <img
                      ...
                      <span class="text-base-100 text-xs px-1 font-common font-normal">
                        {sublink.name}
                      </span>
                    </.link>
                  </div>
